...
CREATE INDEX IF NOT EXISTS idx_transactions_receipt_date  ON transactions (receipt_date);
...
CREATE INDEX IF NOT EXISTS idx_audit_logs_is_confirmed    ON audit_logs (is_confirmed);
